...
public function edit_category_slung(){
    $variable = DB::table('category')->get();
    foreach ($variable as $key => $value) {
...
public function addProductToFacebookPixel(){
    ...
    foreach($Products as $ProAdd){
        ...
        $ImageURL = "https://amanivehiclesounds.co.ke/uploads/product/$ProAdd->image_one";
        $ProExcel  = new ProExcel;
        $ProExcel->id = $ProAdd->id;
