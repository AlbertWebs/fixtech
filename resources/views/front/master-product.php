                                        ...
                                        @if(Auth::user())
                                            ...
                                            <div class="setting ht-setting">
                                                <ul class="ht-setting-list">
                                                    ...
                                                    <li><a href="{{url('/clientarea/logout')}}">Log Out</a></li>
                                                </ul>
                                            </div>
                                        @else
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-9 pl-0 ml-sm-15 ml-xs-15">
                                ...
                                <form action="{{url('/searchsite')}}" method="POST" class="hm-searchbox">
                                    {{csrf_field()}}
                                    ...
                                    <?php $SearchCategory = DB::table('category')->get();?>
                                        ...
                                        <option value="{{$SearchCats->id}}">{{$SearchCats->cat}}</option>
                                        @endforeach
                                    </select>
                                    <input type="text" autocomplete="off"  id="search" name="search"  placeholder="Enter your search key ...">
                                    ...
                                    <ul class="hm-menu">
                                        ...
                                        <li class="hm-minicart">
                                            <div class="hm-minicart-trigger">
                                                ...
                                                <span class="item-text">KES {{ Cart::count() }}
                                        ...
                                        <li class="hm-minicart">
                                            <div class="hm-minicart-trigger">
                                                <span class="item-icon"></span>
                                                <span class="item-text"><small>KES {{ Cart::subtotal() }}</small>
                                                    <span class="cart-item-count">{{ Cart::count() }}</span>
                                                </span>
                                            </div>
                                            <span></span>
                        ...
                        <div class="footer-shipping pt-60 pb-55 pb-xs-25">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                    <div class="li-shipping-inner-box">
                                        <div class="shipping-icon">
                                            <img src="{{asset('theme/images/shipping-icon/3.png')}}" alt="Fixtech Printer Solutions Vehicle Sounds Shipping Icon">
                                        </div>
                                        <div class="shipping-text">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                    <div class="li-shipping-inner-box">
                                        <div class="shipping-icon">
                                            <img src="{{asset('theme/images/shipping-icon/4.png')}}" alt="Fixtech Printer Solutions Vehicle Sounds Shipping Icon">
                                        </div>
                                        <div class="shipping-text">
                            ...
                            <div class="row text-center">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <ul class="des">
                                        ...
                                        <li>
                                            <span>Phone: </span>
                                            <a style="color:#66139B" href="#">{{$Settings->mobile}}</a>
                                            <a style="color:#66139B" href="#">{{$Settings->mobile_one}}</a>
                                        </li>
                                        <li>
                                            <span>Email: </span>
                                            <a style="color:#66139B" href="mailto://{{$Settings->email}}">{{$Settings->email}}</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="footer-links">
                                    <!-- <ul>
                                    <?php $SearchCategory = DB::table('category')->inRandomOrder()->paginate(20);?>
                                        @foreach($SearchCategory as $SearchCats)
                                          <?php $final = preg_replace('#[ -]+#', '-', $SearchCats->cat);?>
                                          <li><a style="color:#66139B; padding:5px; font-weight:400;" href="{{url('/products')}}/{{$final}}">{{$SearchCats->cat}}</a></li>
                                        @endforeach
                                    </ul> -->
                                </div>
                                ...
                                <div class="copyright text-center pt-25">
                                    <!--<span>Copyright &copy; <?php echo date('Y'); ?> <a style="color:#66139B; padding:5px; font-weight:400;" target="_blank" href="https://www.Fixtech Printer Solutionsvehiclesounds.co.ke/copyright"><?php echo $Settings->sitename ?> </a> All Rights Reserved | Powered By <a style="color:#66139B; padding:5px; font-weight:400;" href="http://designekta.com">Designekta Studios</a></span>-->
                                    <span>Copyright &copy; <?php echo date('Y'); ?> <a style="color:#66139B; padding:5px; font-weight:400;" target="_blank" href="{{url('/)}}/copyright"><?php echo $Settings->sitename ?> </a> All Rights Reserved</span>
                                </div>
