...
<head>
    ...
    {{--  --}}
        ...
        <meta property="og:price:amount" content="{{$tProduct->price}}.00"/>
        <meta property="og:price:currency" content="KES"/>
        <meta property="og:availability" content="{{$tProduct->stock}}"/>
        <?php
          $Categoriesname = DB::table('category')->where('id',$tProduct->cat)->get();
         ?>
        @foreach($Categoriesname as $Categoriesname)
        <meta property="product:category" content="{{$Categoriesname->cat}}"/>
        @endforeach
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="copyright text-center pt-25">
                                    <!--<span>Copyright &copy; <?php echo date('Y'); ?> <a style="color:#ce171f; padding:5px; font-weight:400;" target="_blank" href="https://www.Fixtech Printer Solutionsvehiclesounds.co.ke/copyright"><?php echo $Settings->sitename ?> </a> All Rights Reserved | Powered By <a style="color:#ce171f; padding:5px; font-weight:400;" href="http://designekta.com">Designekta Studios</a></span>-->
        ...
        <script type="text/javascript">
            $(function () {
                $('#WAButton').floatingWhatsApp({
                    ...
                    message: 'I have just visited {{url('/')}}/products/{{$slung}}',
