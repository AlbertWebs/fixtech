            ...
            <table class="cart-table table-responsive" style="width:100%">
                ...
                <tr class="Cartproduct">
                  ...
                  <td><div class="product-name">
                      <h4><a style="color:#ce171f;" href="{{url('')}}/classifieds/{{$Product->code}}">{{$Product->name}} </a></h4>
                    </div>
                  ...
                  <form action="{{url('/cart/update')}}/{{$CartItem->rowId}}" id="myform_{{$Product->id}}" method="post">
                      ...
                      <center>
											  <a style="color:#ce171f; cursor: pointer;"  onclick="document.getElementById('myform_{{$Product->id}}').submit()" ><span class="fa fa-undo" ></span> Update</a>
                      </center>
                      <noscript>
                  ...
                  <td class="delete"><a style="color:#ce171f" href="{{url('/')}}/cart/destroy/{{$CartItem->rowId}}" title="Delete"> <i class="fa fa-trash "></i></a></td>
                </tr>
                @endforeach
                @endforeach
