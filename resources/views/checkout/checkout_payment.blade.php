                            ...
                            <div class="order_box_price">
                                ...
                                <div class="payment_list">
                                    ...
                                    @foreach($CartItems as $CartItem)
                                      ...
                                      <h5> Shipping Infomation<span> {{Auth::user()->name}}, {{Auth::user()->mobile}}, {{Auth::user()->location}}, {{Auth::user()->town}}  &nbsp; &nbsp; &nbsp;<span id="updateShippingBtn" style="color:#ce171f; cursor: pointer;" href="#"><i class="fa fa-pencil"></i>   Edit</span></span></h5>
                                      <center>
                                                      ...
                                                      <!-- <div class="form-group clearfix">
                                                        <div class="checkbox">
                                                          <label>
                                                            ...
                                                            I have read and agree to the <a style="color:#ce171f" target="new" href="{{url('/terms')}}">Terms &amp; Conditions</a> </label>
                                                        </div>
                                                      </div> -->
