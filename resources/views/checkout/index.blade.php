            ...
            <div class="col-xs-12 col-sm-6 ">
              ...
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
               ...
               <div class="clearfix"></div>
                    <div class="col-md-12">
                      <button style="background-color:#ce171f; border: 0px; cursor:pointer; text-align:center" class="btn btn-primary text-center" type="submit"><i class="fa fa-user"></i> Create an account</button>
                    </div>
                <br><br>
              </form>
            </div>
            <div class="col-xs-12 col-sm-6 ">
              ...
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="forgot-password">
                  <p><a style="color:#ce171f; cursor:pointer;" href="{{url('/clientarea')}}" title="Recover your forgotten password">Forgot your password? </a></p>
                </div>
                                <div class="clearfix"></div>
                <div class="col-md-12">
                   <button style="background-color:#ce171f; cursor:pointer;" class="btn btn-primary" type="submit"><i class="fa fa-sign-in"></i> Sign In</button>
                </div>
              </form>
            </div>
